...
(async () => {
    url = "https://www.aajtak.in/india/news/story/jagdeep-dhankhar-will-soon-vacate-the-vice-presidents-residence-he-began-packing-ntcpan-rpti-2294442-2025-07-23?utm_source=rssfeed";
    console.log(`🔗 Processing feed: ${url}`);
    await mongoConnect();
    await processUrl(url, '687c75d7d64efc181760e962');
    process.exit(0);
    console.log('✅ Scraping done.');
})().catch(console.error);
